...
IMAGE_SAVE_INTERVAL = 5  # Save images every IMAGE_SAVE_INTERVAL seconds
PROCESS_DURATION = 1  # Process each stream for 2 seconds
...
RTSP_URLS = {
    ...
    'cam4': "http://109.236.111.203/mjpg/video.mjpg"
}
